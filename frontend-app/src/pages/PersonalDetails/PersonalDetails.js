...
function PersonalDetails() {
  ...
  const [postPersonalDetails, isPosting, postError] = usePostPersonalDetails('/personal-details');
  const [updateData, isLoading, updateError] = useUpdatePersonalDetails('/personal-details');
  const [deletePersonalDetails, deleteError] = useDeletePersonalDetails('/personal-details');
  ...
  // Delete a row
  const deleteMyData = useCallback(async (rowIndex) => {
